...
infect_A <- data.frame(A1=c(1:365))
infect_B <- data.frame(A1=c(1:365))
infect_C <- data.frame(A1=c(1:365))
infect_D <- data.frame(A1=c(1:365))
infect_E <- data.frame(A1=c(1:365))
infect_F <- data.frame(A1=c(1:365))
...
infect_A[,j+1] <- sim_data_A$cumulative_infections
...
infect_B[,j+1] <- sim_data_B$cumulative_infections
#### calculate mdh outcomes
...
infect_C[,j+1] <- sim_data_C$cumulative_infections
#### calculate mdh outcomes
...
infect_D[,j+1] <- sim_data_D$cumulative_infections
#### calculate mdh outcomes
...
infect_E[,j+1] <- sim_data_E$cumulative_infections
#### calculate mdh outcomes
...
infect_F[,j+1] <- sim_data_F$cumulative_infections
#### calculate mdh outcomes
...
for(k in c("A", "B", "C", "D", "E", "F")){
  ...
  saveRDS(get(paste0("results_", k))[,-1], file = paste0("data/sa/CalRes_",k, name,".rds"))
  saveRDS(get(paste0("NPI_", k))[,-1], file = paste0("data/sa/Trigger_", k , name,".rds"))
  saveRDS(get(paste0("infect_", k))[,-1], file = paste0("data/sa/Infect_", k , name,".rds"))
